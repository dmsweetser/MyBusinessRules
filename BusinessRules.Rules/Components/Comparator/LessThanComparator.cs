...
{
    public class LessThanComparator : BaseComponent, IAmAComparator
    {
        public LessThanComparator() : base()
        {
            DefinitionId = Guid.Parse("1f7d95a9-b59f-4786-a1f1-0d2f844d93d4");
        }
