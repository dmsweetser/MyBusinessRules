...
{
    public class LessThanOrEqualToComparator : BaseComponent, IAmAComparator
    {
        public LessThanOrEqualToComparator() : base()
        {
            DefinitionId = Guid.Parse("10B81AE6-66FC-4031-80F4-F577F993968D");
        }
