...
{
    [TestClass()]
    public class GreaterThanOrEqualToComparatorTests
    {
        [TestMethod()]
        public void Execute_IfOperandIsGreaterThanOtherOperand_FieldIsUpdated()
        {
            ...
            newRule.Add(new GreaterThanOrEqualToComparator());
        ...
        [TestMethod()]
        public void Execute_IfOperandIsEqualToOtherOperand_ParallelFieldIsUpdated()
        {
            var field1 = new BizField("Field 1");
            var field2 = new BizField("Field 2");
            var field3 = new BizField("Field 3");
        ...
        [TestMethod()]
        public void Execute_IfOperandIsEqualToOtherStaticOperand_ParallelFieldIsUpdated()
        {
            var field1 = new BizField("Field 1");
            var field2 = new BizField("Field 2");
            var field3 = new BizField("Field 3");
